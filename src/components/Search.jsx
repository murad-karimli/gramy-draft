...
function Search() {
  return (
    <div className="w-full sm:w-[70%] flex lg:flex-row flex-col hover:scale-105 transition-all duration-700 hover:bg-[#f9fefe] p-8 sm:bottom-0 sm:absolute bg-[#F9F9F9] z-10 sm:left-56 flex shadow-lg shadow-[#777] justify-between rounded-xl">
      <div className="">
