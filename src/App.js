          ...
          >
            <main className="flex flex-col md:w-[80%]  w-full">
              ...
              data-aos="fade-left">
                  ...
                  <button onClick={closeModal} className="right-4 top-4 absolute">
                    <AiOutlineClose size={30} />
                  </button>
                  <div
                    id="mymodal"
                    className="h-96 p-2 mx-auto w-[90%]"
                  >
                    <img
                    ...
                    <content className="flex flex-col">
                      ...
                      <span className="text-xl font-semibold text-[#40ff] my-2">5 AZN</span>
                      <p className="text-[17px] my-2">Toyuq, turshu , kahi</p>
                      <div className="flex justify-between">
                        <div className="my-4">
                          <button onClick={decreaseAmount} className="p-[6px] text-white mx-2 font-bold text-xl bg-[#08ff] rounded-xl">
                            -
                          </button>
                          <span className="font-semibold text-xl">{amount}</span>
                          <button onClick={increaseAmount} className="p-[6px] text-white text-xl font-bold mx-2 bg-[#08ff] rounded-xl">
                            +
                          </button>
                        </div>
